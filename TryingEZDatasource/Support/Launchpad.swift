...
class LaunchpadViewController: UIViewController {
    ...
    @IBAction func didTapNotActionableNotModelDriven(_ sender: UIButton) {
        App.provider.publish(action: AppProvider.Event.didRequestWeaponList(ofType: .completelyRandom))
    ...
    @IBAction func didTapActionableNotModelDriven(_ sender: UIButton) {
        App.provider.publish(action: AppProvider.Event.didRequestWeaponList(ofType: .rerollable))
    ...
    @IBAction func didTapNotActionableModelDriven(_ sender: UIButton) {
        App.provider.publish(action: AppProvider.Event.didRequestWeaponList(ofType: .descriptionsOnly))
    ...
    @IBAction func didTapActionableReactiveModelDriven(_ sender: UIButton) {
        App.provider.publish(action: AppProvider.Event.didRequestWeaponList(ofType: .upgradable))
    ...
    @IBAction func didTapAllTheThings(_ sender: UIButton) {
        App.provider.publish(action: AppProvider.Event.didRequestWeaponList(ofType: .mixed))
